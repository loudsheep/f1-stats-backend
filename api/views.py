...
from api.services.fastf1.results import get_race_results, get_session_results
from api.services.fastf1.schedule import get_events_remaining, get_event_schedule
from api.services.fastf1.standings import (
...
@api_view(["GET"])
def session_results(request, season, round, session_name):
    return Response(get_session_results(season, round, session_name))
